...
class Tank_auth
{
	...
	function get_user_details1($id){
		$p=$this->ci->user_data_model->getuserid($id);
	...
	function get_user_details2($id){
		$p=$this->ci->user_data_model->get_user($id);
	...
	function get_user_earlier_payments($id){
		$p=$this->ci->user_data_model->get_user_earlier_payments($id);
	...
	function get_posts(){
		$p=$this->ci->user_data_model->get_posts();
		if (!$p==false){
			return $p;
		}
			return false;
	...
	function get_all_users_metas(){
		$p=$this->ci->user_data_model->get_all_users_metas();
		if (!$p==false){
			return $p;
		}
			return false;
	...
	function get_all_users_data(){
		$p=$this->ci->user_data_model->get_all_users_data();
		if (!$p==false){
			return $p;
		}
			return false;
